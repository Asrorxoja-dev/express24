    ...
    <div className="mt-14 bg-slate-200 p-10">
        <div className="px-2 lg:px-20"> 
           ...
           <div className="flex text-center items-center mb-10 gap-10">
                <p className="cursor-pointer text-sm lg:text-xl text-slate-400">О нас</p>
                <p className="cursor-pointer text-sm lg:text-xl text-slate-400" >Контакты</p>
                <p className="cursor-pointer text-sm lg:text-xl text-slate-400">Пользовательское соглашение</p>
            </div>
            <div>
              <h3 className="mb-7 text-sm lg:text-xl text-slate-400">
